...
function TaskCard({ title, description, tag, attachments, deadline }) {
  return (
    <article className="task-card">
      ...
      <footer className="task-card__footer">
        <span className="task-card__meta">
          ...
          {attachments != null && attachments > 0 && <span>{attachments}</span>}
        </span>
        <span className="task-card__meta task-card__flag">
